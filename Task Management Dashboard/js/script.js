...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function promptForNameAndEmail() {
        ...
        `,
            ...
            if (result && result.dismiss !== "cancel") {
                ...
                const finalName = name || "Mr devansh ";
                const finalEmail = email || "devanshsen46@gmail.com";
    ...
    if (
        preferences.name === "Tech_devaa" &&
        preferences.email === "devanshsen46@gmail.com@gmail.com"
    ) {
